...
const createSearchSectionAds = () => `
      <h1 class="heading-1" tabindex="0">Cari Rawat Inap Rumah Sakit Covid-19</h1>
      <p tabindex="0">Ranavid App dapat membantu anda dalam mencari ketersediaan tempat tidur pasien rawat inap rumah sakit</p>
